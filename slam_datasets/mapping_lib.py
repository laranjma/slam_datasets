"""Core occupancy-map and trajectory utilities.

This module is the library side of the occupancy-map generator.

Suggested grouping while refactoring:
    - Data types: RelationEdge, ScanSample, GraphNode
    - Pose math: normalize_angle, compose_pose, invert_pose, between_pose
    - Input parsing: parse_relations, load_scans
    - Selection/builders: determine_scan_subset, build_ground_truth_pose_map,
      build_pose_graph_map
    - Alignment helpers: align_ground_truth_trajectory,
      align_pose_graph_to_odom_trajectory, split_ground_truth_by_component
    - Mapping/plotting: compute_grid_bounds, build_occupancy_grid, save_plot
"""
...
# ---------------------------------------------------------------------------
# Selection, editing and data filtering utilities
# ---------------------------------------------------------------------------
